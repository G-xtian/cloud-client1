    ...
    <el-scrollbar class="wl-main-scroll">
      ...
      <div class="wl-main-list">
        ...
        >
          ...
          <el-table-column property="validNum" label="分享时长">
            <template #default="scope">
              <span style="margin-left: 5px" >{{scope.row.validNum}} 天</span>
            </template>
          </el-table-column>
...
const self_data = ref([]);
const queryShare = () => {
  axios.get("/getMyShare",{params:{userUuid:sessionStorage.getItem("userUuid")}}).then((res) => {
